        ...
        <div className="nav__mobile-inner">
          ...
          <div className="nav__mobile-footer">
            <div className="nav__mobile-social">
              <a href="https://www.instagram.com/2x2voix" className="nav__social-link nav__mobile-social-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer" onClick={closeMenu}>
